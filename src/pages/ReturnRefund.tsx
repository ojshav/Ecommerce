            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-6">
                <Step icon={<Package size={20} />} title="Initiate Return">
                  <p>
                    Start your return online through your Aoin account or contact our customer service team at <a href="mailto:auoinstore@gmail.com" className="text-[#FF4D00] hover:underline">auoinstore@gmail.com</a> with your order number and reason for return.
                  </p>
                </Step>
