...
const Shop3Wishlist: React.FC = () => {
  const { wishlistItems: shop3WishlistItems, isLoading: loading } = useShopWishlistOperations(SHOP_ID);
    ...
    return (
      <div className="container mx-auto px-4 py-6 flex items-center justify-center min-h-[60vh]">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500">Loading your Shop 3 wishlist...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto w-full py-6">
        <div className="flex flex-col max-w-[1440px] items-center justify-center min-h-[60vh] text-center bg-white rounded-lg shadow-sm p-8 mx-auto">
          ...
          <h2 className="text-2xl font-semibold mb-3">Your Shop 3 wishlist is empty</h2>
    ...
    <div className="container w-full mx-auto px-4 py-6">
      <div className="bg-white max-w-[1440px] rounded-lg shadow-sm p-6 mb-8 mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-semibold mb-1">My Shop 3 Wishlist</h1>
            <p className="text-gray-500">{shop3WishlistItems.length} {shop3WishlistItems.length === 1 ? 'Item' : 'Items'}</p>
          </div>
          <button
            onClick={() => navigate('/shop3')}
