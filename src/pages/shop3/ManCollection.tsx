    ...
    <div className="min-h-screen flex flex-col bg-black text-white">
      ...
      <main className="flex-1">
        <section className="max-w-[1380px] mx-auto px-6 py-12">
          <h1 className="text-[#CCFF00] font-bebas text-5xl tracking-tight mb-2 uppercase">Men's Collection</h1>
          <p className="text-[#939393] font-alexandria max-w-3xl">Explore elevated streetwear essentials for men. Modern silhouettes, premium fabrics, and everyday comfort with a minimalist edge.</p>
        </section>

        <section className="max-w-[1380px] mx-auto px-6 pb-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {["Tees", "Hoodies", "Shackets", "Bottoms", "Accessories", "Footwear"].map((label) => (
            <div key={label} className="border border-neutral-800 rounded-lg p-6 bg-neutral-950 hover:bg-neutral-900 transition-colors">
              ...
              <p className="text-[#939393] text-sm font-alexandria">Refined daily pieces in premium fabrics.</p>
            </div>
          ))}
        </section>
