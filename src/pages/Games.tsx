        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {games.map((game, idx) => (
            <div
              ...
              className={`${game.color} rounded-3xl p-8 cursor-pointer shadow-xl transition hover:scale-105 hover:shadow-2xl border-2 border-orange-200 hover:border-orange-400`}
              style={{
              ...
              {wonCodes.map((code, index) => (
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="bg-white px-3 py-1 font-mono text-sm font-semibold rounded mb-1 text-gray-800">
                      {code.code}
                    </div>
