    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-4 md:px-6 lg:px-16 xl:px-32 2xl:px-6 py-16">
        ...
        <div className="mt-8 p-5 border-t border-gray-200 text-sm text-gray-600">
          ...
          <p>This cancellation policy is subject to change. Please check back regularly for updates. For questions about this policy, contact us at infoaoinstore@gmail.com or call 989 336 1102.</p>
        </div>
      </div>
    </div>
  );
