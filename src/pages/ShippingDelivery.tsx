...
const ShippingDelivery = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-[1440px] mx-auto px-100 md:px-11 lg:px-12 xl:px-28 2xl:px-6 py-16">
        ...
        <div className="mt-8 p-4 bg-[#FFF9E5] border border-[#FF4D00]/20 rounded-lg">
          ...
          <p className="text-gray-700">
            ...
            at <span className="font-medium text-[#FF4D00]">support@yourstore.com</span> or call us at <span className="font-medium text-[#FF4D00]">1-800-123-4567</span>.
          </p>
        </div>
      </div>
    </div>
