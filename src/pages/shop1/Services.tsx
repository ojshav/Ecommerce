        ...
        <div className="w-[1280px] max-w-full mx-auto px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
              <div className="w-16 h-16 bg-[#062229] rounded-full flex items-center justify-center mb-6">
      ...
      <section className="py-20 bg-gray-50">
        <div className="w-[1280px] max-w-full mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-20 h-20 bg-[#062229] rounded-full flex items-center justify-center mb-6 mx-auto">
