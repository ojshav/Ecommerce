...
const ProductPage = () => {
  return (
    <div className="min-h-screen bg-black  text-white font-sans px-10 pb-12">
      ...
      <div className="pt-6 pb-2 flex flex-col gap-2">
        ...
        {/* Horizontal line below breadcrumb */}
        <div className="w-full mt-2 mb-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="1" viewBox="0 0 1920 1" fill="none">
