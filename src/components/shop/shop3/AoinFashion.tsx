...
const AoinFashion: React.FC = () => {
  return (
    <div className="bg-black w-full mx-auto relative flex flex-col items-center justify-start py-4 pb-4 lg:pb-20 px-2 sm:px-4">
      {/* Yellow Banner */}
      ...
      <div className="mx-auto max-w-[1440px] w-full px-2 sm:px-4 flex flex-col items-center">
        ...
        {/* Images Row */}
        <div className="relative flex flex-col nav2:flex-row items-center nav2:items-end justify-center gap-4 mb-8 sm:mb-10 md:mb-12 w-full max-w-full md:max-w-5xl">
          ...
          <img
            ...
            className="hidden nav2:block absolute left-[700px] lg:left-[800px] top-[1290px] lg:top-[390px] -translate-x-1/2 -translate-y-1/2 z-10 pointer-events-none"
            style={{ width: 581, height: 581, opacity: 1 }}
          />

          {/* Images */}
          <div className="hidden md:block rounded-3xl overflow-hidden w-[427px] h-[427px] flex-shrink-0 shadow-lg mb-4 md:mb-0 z-20">
            <img
              src={IMAGE1_URL}
              alt="Aoin Fashion 1"
          ...
          {/* Center Circle Image */}
          <div className="rounded-full overflow-hidden w-[340px] h-[340px] sm:w-[350px] sm:h-[350px] md:w-[427px] md:h-[427px] flex-shrink-0 border-4 sm:border-8 border-black relative flex items-center justify-center shadow-lg mb-4 md:mb-0 z-20">
            <img
              src={IMAGE2_URL}
              alt="Aoin Fashion 2"
              className="object-cover w-full h-full"
