...
//         </div>
//         <p className="text-gray-400 text-sm mb-6 w-[256px] h-[30] Top-[4061px] Left-[832px]">
//           Based on {totalReviews} Review{totalReviews !== 1 ? 's' : ''}, Rating is Calculated
//         </p>
//         <button
//           onClick={() => setShowWriteReview(!showWriteReview)}
//           className="bg-[#B19D7F]  text-white px-8 py-3 rounded  font-medium tracking-wide transition-colors duration-200 uppercase text-sm"
//         >
//           Write a Review
//         </button>
//       </div>
...
//                     className="p-1"
//                   >
//                     <StarRating rating={star <= newReview.rating ? star : 0} size="lg" />
//                   </button>
//                 ))}
//               </div>
//             </div>
