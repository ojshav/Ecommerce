      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-20 lg:gap-40 bg-black">
        ...
        <div className="flex flex-col">
          <div className="relative w-full aspect-[770/844] bg-cover bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/do3vxz4gw/image/upload/v1754144772/public_assets_shop4/public_assets_shop4_ShopCollection1.svg')] group">
            {/* Content overlay for screens up to lg */}
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-8 lg:hidden">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-normal leading-tight text-white mb-4 sm:mb-6 md:mb-8 capitalize" style={{ fontFamily: 'ABeeZee' }}>
                Purity. Power. Purpose – The Essence of RudraRAKSH
              </h2>
              <Link 
                to="/shop4-Allproductpage"
                className="px-6 sm:px-8 h-12 sm:h-[50px] bg-[#BB9D7B] text-white font-futura text-sm sm:text-[14px] uppercase tracking-wider hover:bg-[#A88A6A] transition-colors text-center flex items-center justify-center"
              >
                Shop Collections
              </Link>
            </div>
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 lg:mt-12 max-w-full hidden lg:block">
            ...
            <Link 
              to="/shop4-Allproductpage"
              className="w-full sm:w-auto px-6 sm:px-8 py-4 h-12 sm:h-[50px] bg-[#BB9D7B] text-white font-futura text-sm sm:text-[14px] uppercase tracking-wider hover:bg-[#A88A6A] transition-colors flex-shrink-0"
            >
              Shop Collections
            </Link>
          </div>
