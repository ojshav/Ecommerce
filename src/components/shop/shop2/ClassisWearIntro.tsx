...
const ClassicWearIntro = () => {
  const navigate = useNavigate();
  return (
    <section className=" relative w-full mx-auto min-h-screen flex items-center justify-center">
      {/* Left Content */}
      <div className="flex flex-col mb-24 gap-1  max-w-[600px] px-4 sm:px-6 md:px-8 lg:px-8">
        <h1 className="text-gray-800 text-[32px] sm:text-[40px] md:text-[50px] lg:text-[60px] leading-[1] font-archivio mb-6 sm:mb-8 lg:mb-24 font-black">
          EXPERIENCE THE <br />
          EVOLUTION OF <br />
          STREETWEAR <br />
          FASHION
        ...
        <div className="bg-[#05002e] p-4 sm:p-6 lg:p-8 rounded-[14px] text-white w-full sm:w-[280px] md:w-[300px] lg:w-[315px] h-[280px] sm:h-[320px] md:h-[340px] lg:h-[350px] flex flex-col justify-between">
            <div>
      ...
      <div className=" hidden sm:block relative w-full sm:w-[500px] md:w-[600px] lg:w-[692px] h-[300px] sm:h-[400px] md:h-[450px] lg:h-[510px] mt-12 sm:mt-16 md:mt-20 lg:mt-24 px-4 sm:px-6 md:px-8 lg:px-0">
        {/* Text Overlay */}
        <div className="absolute -top-48 sm:-top-48 md:-top-48 lg:-top-48 left-8 sm:left-16 md:left-32 lg:left-64 max-w-[300px] sm:max-w-[400px] lg:max-w-[500px] text-[14px] sm:text-[16px] lg:text-[18px] text-gray-800 leading-relaxed z-20">
        ...
        <div
          className="w-full h-full bg-[#05002e]"
          style={{
...
export default ClassicWearIntro;
