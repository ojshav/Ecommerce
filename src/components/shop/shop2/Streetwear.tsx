...
const Streetwear: React.FC = () => {
  return (
    <section className="relative w-screen sm:h-[140vh] md:h-[135vh] lg:h-[100vh] xl:h-[80vh] h-[100vh] bg-[url('/assets/shop2/bg-image.png')] bg-cover bg-center overflow-hidden flex items-center justify-center py-16 sm:py-0">
