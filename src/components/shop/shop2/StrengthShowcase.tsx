...
const StrengthShowcase = () => {
  ...
  return (
    <section className="relative w-full min-h-screen px-4 sm:px-6 lg:px-8 py-6 pt-20 sm:pt-24 lg:pt-28 font-sans text-white">
      {/* Top Grid */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-40 md:gap-40 lg:gap-8 mb-12 sm:mb-16 lg:mb-24">
        ...
        <div className="lg:col-span-2 relative rounded-xl sm:rounded-2xl overflow-hidden h-[250px] sm:h-[350px] md:h-[400px] lg:h-[511px] bg-black/50">
          <img
            src="https://d3995ea24pmi7m.cloudfront.net/fit-in/668x465/media/wysiwyg/home-page/new-curation/desktop-seasons.png"
        ...
        <div className="hidden lg:block relative h-[300px] sm:h-[400px] md:h-[450px] lg:h-[511px] w-full">
          {/* Background card */}
          <div className="absolute inset-0 bg-[#05002e] rounded-xl sm:rounded-2xl z-0" />
      ...
      <div className="max-w-4xl mx-auto mb-8 sm:mb-10 flex justify-center lg:justify-end -mt-6 sm:-mt-8 lg:-mt-12 xl:-mt-20">
        <button 
          ...
          className="flex items-center gap-3 sm:gap-6 bg-transparent border border-[#D86342] text-[#D86342] px-4 sm:px-5 pr-2 py-2 rounded-full text-xs sm:text-sm hover:bg-[#D86342]/10 transition cursor-pointer"
        >
          <span className="-ml-1">MORE ABOUT US</span>
          <span className="bg-[#D86342] w-5 h-5 sm:w-6 sm:h-6 rounded-full flex items-center justify-center">
      ...
      {/* Newsletter Section */}
      <div className="max-w-6xl mx-auto mt-8 sm:mt-8 lg:mt-8 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-[200px] items-center text-center lg:text-left">
      {/* Left Heading */}
        <h2 className="text-[28px] sm:text-[36px] md:text-[44px] lg:text-[50px] mt-24 xl:text-[60px] tracking-tighter font-extrabold font-archivio leading-tight text-gray-900">
          STAY UPDATED <br />
          WITH EXCLUSIVE <br />
          STREETWEAR
        </h2>
        ...
        <div className="space-y-3 sm:space-y-4 mt-4 sm:mt-6 lg:mt-40 w-full max-w-[429px] items-center mx-auto lg:mx-0">
          <p className="text-gray-800 font-archivio text-sm sm:text-base">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex flex-col items-center sm:flex-row gap-2">
            ...
            <button 
              type="submit"
              disabled={newsletterLoading}
              className="bg-[#D86342] px-4 sm:px-6 py-2 text-white font-semibold hover:bg-[#ec9b84] transition text-sm sm:text-base disabled:opacity-50"
            >
