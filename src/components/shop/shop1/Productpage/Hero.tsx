                      ...
                      if (attribute.name.toLowerCase() === 'color' && colorStyle) {
                        return (
                          <button
                            ...
                            className={`w-[48px] h-[48px] rounded-full border-4 transition-all duration-150 focus:outline-none shadow-md flex items-center justify-center ${isSelected
          ...
          <div className="flex space-x-4 mb-6 ">
            ...
            ${size === 'L'
              ...
              >
                {size}
                <span
                  className={`absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-5 h-1 rounded-full ${size === 'L' ? 'bg-transparent' : 'bg-[#FEEBD8]'
                    }`}
                />
              </div>
            ))}
