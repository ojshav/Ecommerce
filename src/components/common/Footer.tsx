        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <div className="h-10 w-10 rounded-lg bg-primary-500 text-white flex items-center justify-center">
                <Store size={24} />
              </div>
              <span className="text-xl font-semibold">ShopEasy</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/register-business" className="text-gray-400 hover:text-white transition-colors">Sell on ShopEasy</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">123 Commerce St, Suite 500<br />New York, NY 10001</span>
              </li>
