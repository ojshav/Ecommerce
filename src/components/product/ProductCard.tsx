...
const ProductCard: React.FC<ProductCardProps> = ({ 
  ...
  return (
<div className="rounded-xl bg-transparent shadow-none hover:shadow-none transition-all duration-300 flex flex-col w-full max-w-[172px] min-h-[316px] mx-auto">
