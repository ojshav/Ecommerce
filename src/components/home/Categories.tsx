      ...
      <div className="container mx-auto px-4">
        ...
        >
          {categories.map((category) => (
            ...
            className="relative overflow-hidden z-10 flex-shrink-0 w-44 h-44 bg-[#F3FBEE] rounded-full flex flex-col items-center justify-center text-center px-2 py-[26px] transition duration-200 hover:bg-[#FFDADE] hover:category-hover-shadow"
          >
